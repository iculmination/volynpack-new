...
const SheetBlock = () => {
  return (
    <section id="sheet" className="hidden lg:flex justify-evenly py-32 w-full container py-20 lg:grid grid-rows-2 grid-cols-3 gap-10 text-white text-xl relative">
